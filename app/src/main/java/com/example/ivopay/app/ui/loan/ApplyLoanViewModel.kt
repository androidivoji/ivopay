...
class ApplyLoanViewModel(context: Context) : ViewModel() {
    ...
    fun submitApply(bitmap: Bitmap, onSuccess: (String) -> Unit, onError: (String) -> Unit) {
        isLoading = true
        viewModelScope.launch {
            try {
